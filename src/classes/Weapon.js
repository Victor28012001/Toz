...
import { getWeaponSoundManager } from "./WeaponSoundManager.js";
...
export default class Weapon {
  ...
  fire(scene, pitchObj = null, threeObj = null) {
    ...
    soundManager.playWeaponShot(this);

    // ✅ Only create muzzle flash if there's a muzzle to find
    if (pitchObj || threeObj) {
  ...
  startReload() {
    ...
    // Play reload sound
    const soundManager = getWeaponSoundManager();
    soundManager.playWeaponReload(this);
